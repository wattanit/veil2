//! Tauri v2 shell over `veil-core` (Spec §5.3). Phase 5 builds the shell,
//! the security configuration, and the entry list — the unlock screen,
//! vault creation, and every other product surface belong to Phase 6.
